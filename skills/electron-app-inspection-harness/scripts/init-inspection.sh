...
for sub in ['00-meta','01-runtime/screenshots','01-runtime/dom','01-runtime/accessibility','01-runtime/console-network','01-runtime/performance','02-static-asar','03-mcp','04-os-automation/screenshots','05-ui-ux-report','06-codex-tasks','.tooling']:
...
manifest={
  'schemaVersion':'4.0.0','appContext':'00-meta/app-context.json','capabilityLedger':'00-meta/capability-ledger.json','routeDecision':'00-meta/route-decision.md','runtime':'01-runtime/','staticAsar':'02-static-asar/','mcp':'03-mcp/','osAutomation':'04-os-automation/','uiUxReport':'05-ui-ux-report/','codexTasks':'06-codex-tasks/',
  'readOrder':['00-meta/manifest.json','00-meta/app-context.json','00-meta/capability-ledger.json','05-ui-ux-report/inspection-report.md','05-ui-ux-report/design-tokens.json','05-ui-ux-report/component-inventory.md','05-ui-ux-report/interaction-matrix.md','06-codex-tasks/task-contract.json']
}
