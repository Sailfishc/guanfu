...
## Classify drafting mode

Pick one mode before outlining:
...
Compare against the polished reference:

| Element | Rule |
|---|---|
| Title | Do not reuse syntax, key phrase, or concept sequence |
| Opening | Use a different scene, or reframe the same scene from a different reader pain |
| First 3 sections | Must visibly differ in order and emphasis |
| Main metaphor | Avoid reference metaphor unless it comes directly from raw source |
...
- Move from career change to team operating system.
- Move from product role to product release system.
- Move from AI coding technique to feedback infrastructure.
...
- Same first example.
- Same section order.
- Same final career implications.
